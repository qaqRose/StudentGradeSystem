...
<section class="Hui-article-box">
	...
	班级成绩 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="cl pd-20 ">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="text-c">
						...
						<td>
							<a href="<?php echo U('grade/student?s_id='.$vo['id']);?>"><?php echo ($vo["course_name"]); ?></a>
						</td>
						<td><?php echo ($vo["major"]); ?></td>
						<td><?php echo ($vo["class"]); ?></td>
						<td><?php echo ($vo["teacher"]); ?></td>
						<td><?php echo ($vo["tno"]); ?></td>
						<td><?php echo ($vo["avg_grade"]); ?></td>
						<td><?php echo ($vo["max_grade"]); ?></td>
						<td><?php echo ($vo["min_grade"]); ?></td>
						<td><?php echo ($vo["pass_rate"]); ?></td>
