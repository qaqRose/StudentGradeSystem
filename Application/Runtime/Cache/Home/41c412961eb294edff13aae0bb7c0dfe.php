...
<section class="Hui-article-box">
	...
	<nav class="breadcrumb">
      <i class="Hui-iconfont">&#xe67f;</i>
			...
			学生信息 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" >
				<i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="<?php echo U('student/add');?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 增加学生</a></span></div>
				...
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<tbody>
						<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="text-c">
							...
							<td class="td-manage">
								<a style="text-decoration:none" class="ml-5" href="<?php echo U('student/modify?id='.$vo['id']);?>" title="修改信息"><i class="Hui-iconfont">&#xe63f;</i></a>
								<a title="删除" href="<?php echo U('student/delete?id='.$vo['id']);?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
							</td>
