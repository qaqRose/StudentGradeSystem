...
<section class="Hui-article-box">
	...
	<nav class="breadcrumb">
		...
		修改学生信息 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="cl pd-20" style="width:440px; margin:0 auto;">

      <form action="<?php echo U('Student/update');?>" method="post" class="form form-horizontal" id="form-member-add">

        <input type="hidden" name="id" value="<?php echo ($vo["id"]); ?>">
       <div class="row cl">
         <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>学号</label>
         <div class="formControls col-xs-8 col-sm-9">
           <input type="text" name="no" value="<?php echo ($vo["no"]); ?>" class="input-text" placeholder="">
         </div>
       </div>
       <div class="row cl">
         <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>姓名</label>
         <div class="formControls col-xs-8 col-sm-9">
           <input type="text" name="name" value="<?php echo ($vo["name"]); ?>" class="input-text" placeholder="">
         </div>
       </div>
       <div class="row cl">
       ...
       <div class="row cl">
         ...
         <div class="formControls col-xs-8 col-sm-9">
           <input type="text" name="class" value="<?php echo ($vo["class"]); ?>" class="input-text"  placeholder="">
         </div>
       </div>
       <div class="row cl">
