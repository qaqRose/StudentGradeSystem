...
<section class="Hui-article-box">
	...
	<nav class="breadcrumb">
		...
		增加课程管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="cl pd-20" style="width:440px; margin:0 auto;">

		<form action="<?php echo U('baseCourse/addCheck');?>" method="post" class="form form-horizontal" id="form-member-add">
     <div class="row cl">
       <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>课程名称</label>
       <div class="formControls col-xs-8 col-sm-9">
				 <input type="text" name="course_name" value="" class="input-text" placeholder="">
       </div>
     </div>
		 <div class="row cl">
       <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>学分</label>
       <div class="formControls col-xs-8 col-sm-9">
				 <input type="text" name="credit" value="" class="input-text" placeholder="">
       </div>
     </div>
		 <div class="row cl">
       <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>任课老师</label>
       <div class="formControls col-xs-8 col-sm-9">
				 <input type="text" name="teacher" value="" class="input-text" placeholder="">
       </div>
     </div>
		 <div class="row cl">
       <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>老师工号</label>
       <div class="formControls col-xs-8 col-sm-9">
				 <input type="text" name="tno" value="" class="input-text" placeholder="">
       </div>
     </div>
